...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float ft = floor(t);
		if (ft == 0.0f) {
			human.MixPose(base, walk1, t - ft);
		}
		else if (ft == 1.0f) {
			human.MixPose(walk1, walk2, t - ft);
		}
		else if (ft == 2.0f) {
			human.MixPose(walk2, walk1, t - ft);
		}
		else if (ft == 3.0f) {
			human.MixPose(walk1, walk2, t - ft);
		}
		else if (ft == 4.0f) {
			human.MixPose(walk2, stop, t - ft);
		}
		else if (ft == 5.0f) {
			human.MixPose(stop, kick1, t - ft);
		}
		else if (ft == 7.0f) {
			human.MixPose(kick1, kick2, t - ft);
		}
		else if (ft == 8.0f) {
			human.MixPose(kick2, kick3, t - ft);
		}
